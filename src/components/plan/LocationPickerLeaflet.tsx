...
import { MapAutoResize } from '@/src/components/mapa/MapAutoResize';
...
export function LocationPickerLeaflet({ initialLat, initialLng, flyTo, onRegionChange }: LocationPickerProps) {
  ...
  return (
    <View style={{ flex: 1, position: 'relative' }}>
      <MapContainer
        ...
        zoom={17}
        style={{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, background: colors['surface-container'] }}
        zoomControl={false}
